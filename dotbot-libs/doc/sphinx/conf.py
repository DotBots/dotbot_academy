...
# -- Options for breathe ------------------------------------------------------
breathe_projects = {"DotBot-libs": "../doxygen/xml/"}
breathe_default_project = "DotBot-libs"
...
json_url = "https://dotbot-libs.readthedocs.io/en/latest/_static/switcher.json"
